...
public class RampRightAuto extends SequentialCommandGroup {
  /** Creates a new ExampleAuto. */
  public RampRightAuto(CANDriveSubsystem driveSubsystem, CANFuelSubsystem fuelSubsystem, ClimberSubsystem climberSubsystem) {
